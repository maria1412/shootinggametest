...
function makeEnemy (positionX: number, positionY: number) {
    Enemychara = sprites.create(img`
        ........................
        ........................
        ........................
        ........................
        ...
        ........................
        `, SpriteKind.Enemy)
    Enemychara.setPosition(positionX, positionY)
    Enemychara.follow(mySprite, 10)
}
...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    if (controller.dx() == 0 && controller.dy() == 0) {
        projectile = sprites.createProjectileFromSprite(img`
            ...
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            `, mySprite, pastdx * bulletspeed, pastdy * bulletspeed)
        music.pewPew.play()
    } else {
        projectile = sprites.createProjectileFromSprite(img`
            . . . . . . . . . . . . . . . . 
            ...
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            `, mySprite, controller.dx() * bulletspeed, controller.dy() * bulletspeed)
        pastdx = controller.dx()
        pastdy = controller.dy()
        music.pewPew.play()
    }
})
let randomPositionState = 0
let pastdy = 0
let pastdx = 0
let projectile: Sprite = null
let Enemychara: Sprite = null
let bulletspeed = 0
...
game.onUpdateInterval(2000, function () {
    randomPositionState = randint(1, 4)
    if (randomPositionState == 1) {
        makeEnemy(randint(0, randint(0, 120)), 1)
    } else if (randomPositionState == 2) {
        makeEnemy(randint(150, 160), randint(0, 120))
    } else if (randomPositionState == 3) {
        makeEnemy(randint(0, 160), randint(0, 10))
    } else {
        makeEnemy(randint(0, 160), randint(110, 120))
    }
})
forever(function () {
    console.logValue("x", controller.dx(100))
    console.logValue("y", controller.dy(100))
})
